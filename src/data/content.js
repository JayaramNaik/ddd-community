...
export const SCHOLARSHIPS = [
  { name: "NSP Scholarship",        desc: "National Scholarship Portal — Central Govt scholarships for minority, OBC, SC/ST students.", badge: "Central Govt" },
  { name: "SSP Scholarship",        desc: "State Scholarship Portal — Karnataka state-level scholarships for eligible students.",        badge: "State Govt"  },
  { name: "Vidyadhan",              desc: "Merit-cum-need based scholarship supporting students from economically weaker sections.",      badge: "Foundation"  },
  { name: "Foundation Scholarships",desc: "Private foundations offering merit & need-based scholarships for ambitious students.",        badge: "Private"     },
  { name: "Vidyaposhak",            desc: "Scholarship for students who have excelled in competitive exams, rewarding academic talent.", badge: "Competitive" },
  { name: "More Coming Soon ✨",    desc: "We are constantly curating new scholarships. Stay tuned for regular updates!",               badge: "Soon"        },
];
