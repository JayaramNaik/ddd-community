...
//  Reads approved mentors from Firestore (not content.js)
// ─────────────────────────────────────────────────────────────
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <FadeIn>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            <p style={{ fontFamily: "'Lora',serif", color: dark ? "#64748b" : "#94a3b8", fontSize: 15, marginTop: 12 }}>
              {t.mentors.subtitle}
            </p>
          </div>
        </FadeIn>
        ...
        {!loading && mentors.length === 0 && (
          <div style={{ textAlign: "center", padding: "40px 0" }}>
            <p style={{ fontFamily: "'Lora',serif", color: dark ? "#64748b" : "#94a3b8", fontSize: 15 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 28 }}>
            {mentors.map((mentor, i) => (
              <FadeIn key={mentor.id} delay={i * 0.15}>
                ...
                >
                  {/* Color bar */}
                  <div style={{ height: 6, background: `linear-gradient(90deg,${mentor.gradientFrom || "#38bdf8"},${mentor.gradientTo || "#818cf8"})` }} />
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginTop: 16 }}>
                      {(mentor.interests || []).map(interest => (
                        <span key={interest} style={{
                          background: dark ? "rgba(56,189,248,0.1)" : "rgba(56,189,248,0.1)",
                          border: "1px solid rgba(56,189,248,0.25)",
                          color: "#38bdf8", fontSize: 11, padding: "4px 10px",
                          borderRadius: 20, fontWeight: 600, fontFamily: "'Syne',sans-serif",
                        }}>
                          {interest}
                        </span>
                      ))}
